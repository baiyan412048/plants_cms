<template>
  <header class="sticky top-0 left-0 z-20 shadow">
    <nav class="border-gray-200 bg-white py-2.5 px-4 dark:bg-gray-800 lg:px-6">
      <div class="flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center lg:order-2">
          ...
          >
            <div
              class="block bg-gray-50 py-2 px-4 text-center text-base font-medium text-gray-700 dark:bg-gray-700 dark:text-gray-400"
            >
              Notifications
            </div>
            <div>
              ...
              >
                <div class="flex-shrink-0">
                  ...
                  />
                  <div
                    class="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-gray-900 dark:border-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      class="h-3 w-3 text-white"
              ...
              >
                <div class="flex-shrink-0">
                  ...
                  />
                  <div
                    class="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-red-600 dark:border-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      class="h-3 w-3 text-white"
              ...
              >
                <div class="flex-shrink-0">
                  ...
                  />
                  <div
                    class="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-green-400 dark:border-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      class="h-3 w-3 text-white"
              ...
              >
                <div class="flex-shrink-0">
                  ...
                  />
                  <div
                    class="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-purple-500 dark:border-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      class="h-3 w-3 text-white"
          ...
          >
            ...
            >
              ...
              <li>
                <a
                  href="#"
                  class="flex items-center justify-between py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                >
